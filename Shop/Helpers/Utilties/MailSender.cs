...
namespace Shop.Helpers.Utilties
{
    public static class MailSender
    {
        public static bool SendMail(string subject, string body, params string[] toMails)
        {
            try
            {
                ...
                mailMsg.From = new MailAddress("Omid.green.b13@gmail.com", "سید امید رفیعی", Encoding.UTF8);
                mailMsg.Sender = new MailAddress("Omid.green.b13@gmail.com", "سید امید رفیعی", Encoding.UTF8);
                ...
                smtp.EnableSsl = true;
                smtp.Credentials = new NetworkCredential("Omid.green.b13@gmail.com", "omidsabz10.");
                smtp.Send(mailMsg);
                return true;
            }
            catch
